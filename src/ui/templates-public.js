...
function settingsGrid(state, disabled = false) {
  ...
  return `<div class="settings-grid">
    ...
    <label class="field field--explained"><span>Pre-round Friend Market trading time</span><input name="tradingSeconds" type="range" min="15" max="60" step="5" value="${settings.tradingSeconds}" data-setting="tradingSeconds" ${disabled ? 'disabled' : ''}/><b>${settings.tradingSeconds}s</b><small class="field-help">Every round opens with this countdown. Buy or sell friend stocks before 00:00; orders then close automatically.</small></label>
